...
public static class WorkAndEventTypeFactory
{
    public static Tuple<List<Work>, List<EventType>> Make()
    {
        ...
        var ets1 = new List<EventType>
        {
            new()
            {
                WorkId = w1.Id, Name = "Актуализация экзаменационных билетов промежуточной аттестации",
            ...
            new()
            {
                WorkId = w1.Id, Name = "Актуализация основных образовательных программ высшего образования (ООП ВО)",
                Description = "До 150 часов на группу разработчиков"
            },
            new()
            {
                WorkId = w1.Id, Name = "Актуализация тестовых заданий государственной итоговой (итоговой) аттестации",
                Description = "До 1 час на тестовое задание"
            },
            new()
            {
                WorkId = w1.Id, Name = "Актуализация тестовых заданий промежуточной аттестации",
            ...
            new()
            {
                WorkId = w1.Id, Name = "Актуализация/переработка действующей рабочей программы учебной дисциплины",
            ...
            new()
            {
                WorkId = w1.Id, Name = "Корректировка учебного плана ООП", Description = "20-50 часов на один план"
            },
            new()
            {
                WorkId = w1.Id,
            ...
            new()
            {
                WorkId = w1.Id, Name = "Научное редактирование учебников, учебных пособий",
            ...
            new()
            {
                WorkId = w1.Id, Name = "Подготовка видеофильмов для аудиторных занятий",
                Description = "По решению кафедры"
            },
            new()
            {
            ...
            new()
            {
                WorkId = w1.Id, Name = "Подготовка документов к государственной аккредитации ООП ВО",
            ...
            new()
            {
                WorkId = w1.Id, Name = "Подготовка индивидуальных заданий на производственную и преддипломную практики",
                Description = "0,25 ч. на 1 задание"
            },
            new()
            {
                WorkId = w1.Id, Name = "Подготовка к лекционным занятиям",
                Description =
            ...
            new()
            {
                WorkId = w1.Id, Name = "Подготовка к практическим занятиям по дисциплине",
                Description =
            ...
            new()
            {
                WorkId = w1.Id, Name = "Подготовка материалов для лицензирования направления (специальности)",
                Description = "150 часов"
            },
            new()
            {
            ...
            new()
            {
                WorkId = w1.Id, Name = "Подготовка презентаций для аудиторных занятий",
                Description = "По решению кафедры"
            },
            new()
            {
            ...
            new()
            {
                WorkId = w1.Id, Name = "Подготовка презентаций лекций (для раздачи)", Description = "По решению кафедры"
            },
            new()
            {
                WorkId = w1.Id, Name = "Подготовка раздаточного материала для практических занятий",
                Description = "По решению кафедры"
            },
            new()
            {
                WorkId = w1.Id, Name = "Подготовка слайдов для аудиторных занятий", Description = "По решению кафедры"
            },
            new()
            {
                WorkId = w1.Id,
            ...
            new() { WorkId = w1.Id, Name = "Постановка новой лабораторной работы", Description = "30-60 часов" },
            new() { WorkId = w1.Id, Name = "Модернизация действующих лабораторных работ", Description = "10-30 часов" },
            new()
            {
                WorkId = w1.Id, Name = "Проведение олимпиады со студентами или абитуриентами",
                Description = "4 часа на 1 тур"
            },
            new()
            {
                WorkId = w1.Id, Name = "Проверка олимпиадных работ студентов и абитуриентов",
                Description = "0,3 часа на 1 работу"
            },
            new()
            {
                WorkId = w1.Id, Name = "Проектирование фонда оценочных средств сформированности компетенций",
            ...
            new()
            {
                WorkId = w1.Id, Name = "Работа экспертом Росаккредагентства, Рособрнадзора",
                Description = "До 400 часов в год (по решению УМУ)"
            },
            new()
            {
                WorkId = w1.Id, Name = "Разработка основных образовательных программ высшего образования (ООП ВО)",
                Description = "До 350 часов на группу разработчиков"
            },
            new()
            {
                WorkId = w1.Id, Name = "Разработка виртуальной лабораторной работы",
                Description = "От 50 до 300 час за 80 кБ электронного файла"
            },
            new()
            {
            ...
            new()
            {
                WorkId = w1.Id, Name = "Разработка методических указаний по выполнению ККР, ГР, РГР, ТР, ИБ",
                Description = "20-60 часов на один печатный лист (внутривузовское издание)"
            },
            new()
            {
            ...
            new()
            {
                WorkId = w1.Id, Name = "Разработка методических указаний по лабораторным работам",
                Description = "20-60 часов на один печатный лист (внутривузовское издание)"
            },
            new()
            {
            ...
            new()
            {
                WorkId = w1.Id, Name = "Разработка методических указаний по практическим (семинарским) занятиям",
                Description = "20-60 часов на один печатный лист (внутривузовское издание)"
            },
            new()
            {
                WorkId = w1.Id, Name = "Разработка методических указаний по СРС",
                Description = "20-60 часов на один печатный лист (внутривузовское издание)"
            },
            new()
            {
            ...
            new()
            {
                WorkId = w1.Id, Name = "Разработка рабочей программы учебной дисциплины",
                Description = "20-60 часов на один печатный лист в электронном виде"
            },
            new() { WorkId = w1.Id, Name = "Разработка учебного плана ООП", Description = "До 150 часов на один план" },
            new()
            {
                WorkId = w1.Id, Name = "Разработка электронного учебника",
                Description =
                    "От 100 ч. до 350 ч. в зависимости от объема ( при наличии соавторов часы делятся в соответствии с долей участия)"
            },
            new()
            {
                WorkId = w1.Id, Name = "Редактирование конспекта лекций",
                Description = "До 5 часов на один печатный лист"
            },
            new()
            {
                WorkId = w1.Id, Name = "Рецензирование аттестационной, дипломной, проектной работы по ДОП",
                Description = "3 часа на одну ВКР (одному рецензенту направляется до 8 АР)"
            },
            new()
            {
                WorkId = w1.Id, Name = "Рецензирование бакалаврской работы, дипломного проекта, дипломной работы",
                Description = "2 часа на одну работу (одному рецензенту направляется до 8 работ)"
            },
            new()
            {
                WorkId = w1.Id, Name = "Рецензирование ВКР аспиранта",
                Description = "3 часа на одну ВКР (одному рецензенту направляется до 6 ВКР)"
            },
            new() { WorkId = w1.Id, Name = "Рецензирование КП(Р)", Description = "0,25 часа на один проект" },
            new()
            {
                WorkId = w1.Id, Name = "Рецензирование магистерской диссертации",
                Description = "3 часа на одну диссертацию (одному рецензенту направляется до 6 диссертаций)"
            },
            new()
            {
                WorkId = w1.Id, Name = "Составление заданий для ККР, КР", Description = "До 0,25 часа на один вариант"
            },
            new()
            {
                WorkId = w1.Id, Name = "Составление заданий для РГР, ГР И ТР",
                Description = "До 0,1 часа на один вариант"
            },
            new()
            {
                WorkId = w1.Id, Name = "Составление заданий для олимпиад со студентами или абитуриентами",
                Description = "2 часа на 1 вариант"
            },
            new()
            {
                WorkId = w1.Id, Name = "Составление заданий на курсовое проектирование по общетехническим дисциплинам",
                Description = "До 0,5 часа на одно задание"
            },
            new()
            {
                WorkId = w1.Id, Name = "Составление заданий на курсовое проектирование по специальным дисциплинам",
            ...
            new()
            {
                WorkId = w1.Id, Name = "Составление экзаменационных билетов промежуточной аттестации без задач",
        ...
        var ets2 = new List<EventType>
        {
            new()
            {
                WorkId = w2.Id, Name = "Выступление с докладом на конференции, симпозиуме, съезде",
                Description = "До 20 часов"
            },
            new()
            {
                WorkId = w2.Id, Name = "Выступление с докладом на научном семинаре кафедры", Description = "До 10 часов"
            },
            new()
            {
                WorkId = w2.Id, Name = "Выступление с докладом на Ученом совете университета,  ученом совете института",
                Description = "До 15 часов"
            },
            new()
            {
                WorkId = w2.Id, Name = "Написание и подготовка для издательства монографии или учебника (без гонорара)",
            ...
            new()
            {
                WorkId = w2.Id, Name = "Написание и подготовка для издательства учебного пособия без гонорара",
                Description = "До 100  часов на 1 печатный лист"
            },
            new()
            {
                WorkId = w2.Id, Name = "Научно-техническое консультирование работников предприятий, организаций",
                Description = "Устанавливается заведующим кафедрой по согласованию с УМУ"
            },
            new()
            {
                WorkId = w2.Id, Name = "Осуществление научной деятельности по госбюджетной теме",
            ...
            new()
            {
                WorkId = w2.Id, Name = "Подготовка доклада на международные, российские конференции",
                Description = "До 40 часов на один доклад"
            },
            new()
            {
                WorkId = w2.Id, Name = "Подготовка доклада на методический семинар кафедры",
                Description = "До 5 часов на один доклад"
            },
            new()
            {
                WorkId = w2.Id, Name = "Подготовка доклада на научно-методическую конференцию института",
            ...
            new()
            {
                WorkId = w2.Id,
                Name =
                    "Подготовка документации к проведению сертификационного (инспекционного) аудита системы качества",
                Description = "Устанавливается заведующим кафедрой по согласованию с директором института"
            },
            new()
            {
                WorkId = w2.Id, Name = "Подготовка экспоната на выставку", Description = "40-60 часов на один экспонат"
            },
            new()
            {
                WorkId = w2.Id, Name = "Работа в методической комиссии института",
                Description = "Устанавливается заведующим кафедрой по согласованию с директором института"
            },
            new()
            {
            ...
            new()
            {
                WorkId = w2.Id, Name = "Работа в экспертном совете ВАК", Description = "До 60 часов в год на один совет"
            },
            new()
            {
                WorkId = w2.Id,
            ...
            new()
            {
                WorkId = w2.Id, Name = "Создание результата интеллектуальной деятельности",
        ...
        var ets3 = new List<EventType>
        {
            ...
            new()
            {
                WorkId = w3.Id, Name = "Руководство НИРС в кружке СНО по госбюджетной тематике",
        ...
        var ets4 = new List<EventType>
        {
            new()
            {
                WorkId = w4.Id, Name = "Исполнение обязанностей заместителя директора без занимания должности ",
                Description = "100-300 часов в год"
            },
            new()
            {
                WorkId = w4.Id, Name = "Исполнение обязанностей ответственного по кафедре за воспитательную работу",
                Description = "До 50 часов в год"
            },
            new()
            {
                WorkId = w4.Id, Name = "Исполнение обязанностей ответственного по кафедре за дипломное проектирование",
                Description = "До 50 часов в год"
            },
            new()
            {
                WorkId = w4.Id, Name = "Исполнение обязанностей ответственного по кафедре за курсовое проектирование",
                Description = "До 50 часов в год"
            },
            new()
            {
                WorkId = w4.Id, Name = "Исполнение обязанностей ответственного по кафедре за НИРС",
            ...
            new()
            {
                WorkId = w4.Id, Name = "Исполнение обязанностей ответственного по кафедре по менеджменту качества",
            ...
            new()
            {
                WorkId = w4.Id, Name = "Исполнение обязанностей секретаря ученого совета института",
                Description = "До 50 часов в год"
            },
            new()
            {
                WorkId = w4.Id, Name = "Исполнение обязанностей уполномоченного по качеству института",
                Description = "До 100 часов в год"
            },
            new()
            {
                WorkId = w4.Id, Name = "Исполнение обязанностей Ученого секретаря Ученого совета университета",
                Description = "До 50 часов в год"
            },
            new()
            {
            ...
            new()
            {
                WorkId = w4.Id, Name = "Исполнение обязанностей члена ученого совета института",
                Description = "До 20 часов в год"
            },
            new()
            {
                WorkId = w4.Id, Name = "Исполнение обязанностей члена Ученого совета университета",
                Description = "До 60 часов в год"
            },
            new() { WorkId = w4.Id, Name = "Проведение профориентационной работы", Description = "По решению кафедры" },
            new()
            {
                WorkId = w4.Id, Name = "Работа  руководителем секции (совета) при методическом совете университета",
                Description = "До 100 часов год"
            },
            new()
            {
                WorkId = w4.Id, Name = "Работа в отборочной комиссии факультета", Description = "50 – 100 часов год"
            },
            new()
            {
                WorkId = w4.Id, Name = "Работа в приемной комиссии зам. ответственного секретаря",
                Description = "200 – 600 часов год"
            },
            new()
            {
                WorkId = w4.Id, Name = "Работа в приемной комиссии ответственным секретарем",
                Description = "300 – 700 часов год"
            },
            new()
            {
                WorkId = w4.Id, Name = "Работа в приемной комиссии сотрудником",
            ...
            new()
            {
                WorkId = w4.Id, Name = "Работа членом секции (совета) при методическом совете университета",
                Description = "До 50 часов год"
            },
            new()
            {
                WorkId = w4.Id, Name = "Руководство институтом",
            ...
            new()
            {
                WorkId = w4.Id, Name = "Участие в заседаниях кафедры и работе методических семинаров кафедры",
        ...
        {
            new() { WorkId = w5.Id, Name = "Информационно-воспитательная работа", Description = "По решению кафедры" },
            new()
            {
                WorkId = w5.Id,
                Name =
            ...
            new() { WorkId = w5.Id, Name = "Работа в качестве куратора групп", Description = "50-100 часов в год" },
            new() { WorkId = w5.Id, Name = "Работа со студенческим активом", Description = "По решению кафедры" }
        };
        ...
        var ets6 = new List<EventType>
        {
            new()
            {
                WorkId = w6.Id, Name = "Проведение обследования пациентов с целью установления диагноза",
                Description = "По решению кафедры"
            },
            new()
            {
                WorkId = w6.Id, Name = "Назначение лечения пациенту и контроль его эффективности и безопасности",
                Description = "По решению кафедры"
            },
            new()
            {
                WorkId = w6.Id, Name = "Проведение хирургических операций у больных ",
                Description = "По решению кафедры"
            },
            new()
            {
            ...
            new()
            {
                WorkId = w6.Id, Name = "Оказание медицинской помощи населению.", Description = "По решению кафедры"
            },
            new()
            {
                WorkId = w6.Id,
            ...
            new()
            {
                WorkId = w6.Id, Name = "Организация деятельности подчиненного медицинского персонала",
                Description = "По решению кафедры"
            }
        };
        ...
        var ets7 = new List<EventType>
        {
            new()
            {
                WorkId = w7.Id, Name = "Повышение квалификации в ТулГУ или другом вузе",
