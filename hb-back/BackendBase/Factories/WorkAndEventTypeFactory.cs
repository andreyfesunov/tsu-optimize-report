...
public static class WorkAndEventTypeFactory
{
    public static Tuple<List<Work>, List<EventType>> Make()
    {
        ...
        var ets1 = new List<EventType>
        {
            ...
            new(
                WorkId: w1.Id,
                Name: "Актуализация/переработка для повторного издания методических указаний по самостоятельной работе студентов",
                Description: "До 20 часов на один печатный лист (внутривузовское издание)"
            ),
            new(
                WorkId: w1.Id,
                Name: "Актуализация/переработка для повторного издания методических указаний по курсовому проектированию",
                Description: "До 20 часов на один печатный лист (внутривузовское издание)"
            ),
            new(
                WorkId: w1.Id,
            ...
            new(
                WorkId: w1.Id,
                Name: "Актуализация/переработка для повторного издания методических указаний по подготовке и защите ВКР, учитывающих особенности испытаний по конкурентной ООП",
            ...
            new(
                WorkId: w1.Id,
                Name: "Внедрение в учебный процесс инновационных форм учебных занятий, развивающих у обучающихся навыки командной работы, межличностной коммуникации, принятия решений, лидерские качества",
                Description: "По решению кафедры"
            ),
            new(
                WorkId: w1.Id,
                Name: "Заполнение модуля «Электронный дневник» АИС УУП, внесение информации о посещаемости и успеваемости",
                Description: "0,2 – 0,5 час на группу на одно занятие"
            ),
            new(
                WorkId: w1.Id,
                Name: "Заполнение модуля «Электронный дневник» АИС УУП,привязка видов работ к календарному графику проведения занятий по дисциплине",
            ...
            new(
                WorkId: w1.Id,
                Name: "Корректировка в ЭИОС ТулГУ образовательного контента по реализуемым дисциплинам (модулям), практикам",
                Description: "До 50 часов за корректировку образовательного контента по всем видам занятий, текущему контролю успеваемости и промежуточной аттестации по 1 дисциплине (модулю) или практике"
            ),
            new(
                WorkId: w1.Id,
            ...
            new(
                WorkId: w1.Id,
                Name: "Подготовка и размещение в электронной информационно-образовательной среде университета (ЭИОС ТулГУ) образовательного контента по реализуемым дисциплинам (модулям), практикам",
                Description: "До 100 часов за подготовку и размещение образовательного контента по всем видам занятий, текущему контролю успеваемости и промежуточной аттестации по 1 дисциплине (модулю) или практике, материал по которой, размещается впервые"
            ),
            new(
                WorkId: w1.Id,
            ...
            new(
                ...
                Description: "2-5 часов на 1 час занятий по впервые читаемой дисциплине; 0,5-1 час на 1 час занятий по повторно читаемой дисциплине (дублирование занятий в потоках и группах не учитывается)"
            ),
            new(
                WorkId: w1.Id,
                Name: "Подготовка к практическим занятиям по дисциплине",
                Description: "2-5 часов на 1 час занятий по впервые читаемой дисциплине; 0,5-1 часов на 1 час занятий по повторно читаемой дис-циплине (дублирование занятий в потоках и группах не учитывается)"
            ),
            new(
                WorkId: w1.Id,
            ...
            new(
                WorkId: w1.Id,
                Name: "Подготовка материалов для проведения деловых, ситуационных и ролевых игр, круглых столов, групповых дискуссий, тренингов, и т.п.",
                Description: "6 часа на подготовку к игре проводимой впервые, 3 часа на подготовку к игре при повторном проведении"
            ),
            new(
                WorkId: w1.Id,
            ...
            new(
                WorkId: w1.Id,
                Name: "Разработка комплекта тестовых заданий (в том числе и в электронном виде) государственной итоговой (итоговой) аттестации",
                Description: "До 2 часов на тестовое задание"
            ),
            new(
                WorkId: w1.Id,
                Name: "Разработка комплекта тестовых заданий (в том числе и в электронном виде) промежуточной аттестации",
                Description: "До 1,5 часов на тестовое задание"
            ),
            new(
                WorkId: w1.Id,
                Name: "Разработка методических указаний для преподавателя по проведению индивидуальных занятий по программам магистратуры",
            ...
            new(
                WorkId: w1.Id,
                Name: "Разработка методических указаний по подготовке и защите ВКР, учитывающих особенности испытаний по конкурентной ООП",
            ...
            new(
                WorkId: w1.Id,
                Name: "Разработка программ для интерактивных лекций, деловых и ролевых игр, ситуационных и имитационных моделей, систем автоматизированного проектирования",
            ...
            new(
                ...
                Description: "От 100 ч. до 350 ч. в зависимости от объема ( при наличии соавторов часы делятся в соответствии с долей участия)"
            ),
            new(
                WorkId: w1.Id,
            ...
            new(
                WorkId: w1.Id,
                Name: "Составление экзаменационных билетов промежуточной аттестации с заданиями для контроля практических умений",
                Description: "До 1 часа на билет"
            ),
            new(
                WorkId: w1.Id,
        ...
        var ets2 = new List<EventType>
        {
            ...
            new(
                WorkId: w2.Id,
                Name: "Ответственность за научную деятельность на кафедре при числе преподавателей св. 10 до 20 человек",
            ...
            new(
                WorkId: w2.Id,
                Name: "Подготовка доклада на региональную, всероссийскую, международную, научно-методическую конференцию",
            ...
            new(
                WorkId: w2.Id,
                Name: "Работа в совете по защите кандидатских или докторских диссертаций в качестве заместителя председателя",
            ...
            new(
                WorkId: w2.Id,
                Name: "Рецензирование учебников, учебных пособий, монографий, научных статей, докладов, диссертаций, авторефератов диссертаций, конкурсных и других материалов по заданию кафедры",
        ...
        var ets3 = new List<EventType>
        {
            new(
                WorkId: w3.Id,
                Name: "Руководство НИРС без представления в текущем учебном году студентом научной статьи, научной работы на конкурс НИРС, доклада на научной конференции, симпозиуме, семинаре",
            ...
            new(
                WorkId: w3.Id,
                Name: "Руководство НИРС с представлением в текущем учебном году студентом научной статьи, научной работы на конкурс НИРС, доклада на научной конференции, симпозиуме, семинаре",
        ...
        var ets4 = new List<EventType>
        {
            ...
            new(
                WorkId: w4.Id,
                Name: "Исполнение обязанностей ответственного по кафедре за организацию производственных практик студентов",
            ...
            new(
                WorkId: w4.Id,
                Name: "Работа заместителем заведующего кафедрой по учебной работе при числе преподавателей на кафедре до 10 человек",
                Description: "30 часов в год"
            ),
            new(
                WorkId: w4.Id,
                Name: "Работа заместителем заведующего кафедрой по учебной работе при числе преподавателей на кафедре с 10 до 20 человек",
                Description: "60 часов в год"
            ),
            new(
                WorkId: w4.Id,
                Name: "Работа заместителем заведующего кафедрой по учебной работе при числе преподавателей на кафедре свыше 20 человек",
            ...
            new(
                WorkId: w4.Id,
                Name: "Руководство кафедрой (в т.ч. разработка учебных планов специализаций, планирование и контроль учебной нагрузки, посещение занятий преподавателей кафедры)",
                Description: "До 300 часов в год"
            ),
            new(
                WorkId: w4.Id,
                Name: "Организация и проведение научной конференции на базе кафедры и подготовка к публикации сборника статей (докладов)",
                Description: "Устанавливается заведующим кафедрой до 70 часов в год"
            ),
            new(
                WorkId: w4.Id,
        ...
        var ets5 = new List<EventType>
        {
            ...
            new(
                WorkId: w5.Id,
                Name: "Организация и проведение диагностической работы, работы по ведению мониторинга, работы предусмотренной планами воспитательных, творческих и иных мероприятий, проводимых с обучающимися",
                Description: "По решению кафедры"
            ),
            new(
                WorkId: w5.Id,
                Name: "Организация и проведение спортивных мероприятий (занятий по физической подготовке со студентами в оздоровительно-спортивных лагерях и на учебно-тренировочных сборах, спортивные праздники, вечера,  показательные выступления спортсменов, спортивные соревнования)",
                Description: "По решению кафедры"
            ),
            new(
                WorkId: w5.Id,
        ...
        var ets6 = new List<EventType>
        {
            ...
            new(
                WorkId: w6.Id,
                Name: "Проведение профилактических мероприятий для взрослого населения и детей по возрастным группам и состоянию здоровья, проведение санитарнопросветительной работы по формированию здорового образа жизни и контроль их эффективности",
                Description: "По решению кафедры"
            ),
            new(
                WorkId: w6.Id,
            ...
            new(
                WorkId: w6.Id,
                Name: "Организация лечебнодиагностического процесса (выбор методов диагностики и лечения, лекарственное обеспечение пациентов)",
                Description: "По решению кафедры"
            ),
            new(
                WorkId: w6.Id,
        ...
        var ets7 = new List<EventType>
        {
            ...
            new(
                WorkId: w7.Id,
                Name: "Стажировка на производственном предприятии, в вузе или какой-либо другой организации в другом городе",
